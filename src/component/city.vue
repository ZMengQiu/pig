				...
				<mt-tab-container-item id="1">
					<div class="history">
						...
						<div class="guang">
							...
							<p v-for="(v,i) in list1" @click="change(v.gz)">{{v.gz}}</p>
						</div>
						<p>热门城市</p>
						<div class="hot">
							<p v-for="(v,i) in list0" @click="change(v.hot)">{{v.hot}}</p>
						</div>
					</div>
					...
					<div class="active">
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in lista" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listb" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listc" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listd" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in liste" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listf" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listg" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listh" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listj" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listk" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listl" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listm" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listn" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listp" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listq" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listr" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in lists" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listt" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listw" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listx" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listy" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
						...
						<div>
							...
							<ul class="com">
								<li v-for="(v,i) in listz" @click="change(v.city)">
									{{v.city}}
									<span>{{v.dec}}</span>
								</li>
							</ul>
